...
def crop(o1, o2, i):
	...
	print(o_shape2)
	print('this is output shape of cnn model')
	...
	print(o_shape1)
	print('this is output shape of 1x1 filtered activation map')
	if IMAGE_ORDERING == 'channels_first':
	...
	if output_width1 > output_width2:
		print('size not same case1')
		o1 = Cropping2D(cropping=((0, 0),  (0, cx)), data_format=IMAGE_ORDERING)(o1)
	else:
		print('size not same case2')
		o2 = Cropping2D(cropping=((0, 0),  (0, cx)), data_format=IMAGE_ORDERING)(o2)
	
	if output_height1 > output_height2:
		print('size not same case3')
		o1 = Cropping2D(cropping=((0, cy),  (0, 0)), data_format=IMAGE_ORDERING)(o1)
	else:
		print('size not same case4')
		o2 = Cropping2D(cropping=((0, cy) ,  (0, 0)), data_format=IMAGE_ORDERING)(o2)

	return o1, o2


def fcn_8(n_classes, encoder, input_height=224, input_width=224):
	img_input, levels = encoder(input_height=input_height, input_width=input_width)
	[f1, f2, pool3, pool4, pool5] = levels
	o = pool5
	o = (Conv2D(1000, (7, 7), activation='relu', padding='same', name='conv66', data_format=IMAGE_ORDERING))(o)  # conv6
	o = (Conv2D(1000, (1, 1), activation='relu', padding='same', name='conv7', data_format=IMAGE_ORDERING))(o)  # conv7
	o = Conv2DTranspose(n_classes, kernel_size=(4, 4), strides=(4, 4), use_bias=False, data_format=IMAGE_ORDERING)(o)

	o2 = pool4
	o2 = (Conv2D(n_classes, (1, 1), activation='relu', padding='same', name='conv6', data_format=IMAGE_ORDERING))(o2)
	o2 = Conv2DTranspose(n_classes, kernel_size=(2, 2), strides=(2, 2), use_bias=False, data_format=IMAGE_ORDERING)(o2)

	o3 = pool3
	o3 = Conv2D(n_classes, (1, 1), activation='relu', padding='same', name="o3", data_format=IMAGE_ORDERING)(o3)

	o = Add(name="add")([o, o2, o3])
...
def fcn_8_temp(n_classes, encoder, input_height=224, input_width=224):
...
def fcn_32(n_classes, encoder=vanilla_encoder,  input_height=224, input_width=224):
	...
	o = (Conv2D(1000, (7, 7), activation='relu' , padding='same', data_format=IMAGE_ORDERING))(o)
	o = Dropout(0.5)(o)
	o = (Conv2D(1000, (1, 1), activation='relu' , padding='same', data_format=IMAGE_ORDERING))(o)
	o = Dropout(0.5)(o)
...
def fcn_8_resnet50(n_classes,  input_height=224, input_width=224):
...
def fcn_32_resnet50(n_classes,  input_height=224, input_width=224):
