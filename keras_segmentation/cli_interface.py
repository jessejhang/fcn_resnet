...
def cli_train():
	...
	parser.add_argument("--model_name", type = str, default= "fcn_8_resnet50")
	parser.add_argument("--train_images", type = str, default = "C:/img/train_images")
	parser.add_argument("--train_annotations", type = str, default = "C:/img/train_labels")
...
def cli_predict():
	...
	parser.add_argument("--input_path", type=str, default="C:/img/val_images")
	parser.add_argument("--output_path", type=str, default="C:/img/predict_result")
...
def cli_verify_dataset():
	...
	parser = argparse.ArgumentParser()
	parser.add_argument("command", type = str)
	parser.add_argument("--images_path", type = str, default="C:/img/train_images")
	parser.add_argument("--segs_path", type = str, default="C:/img/train_labels")
	parser.add_argument("--n_classes", type=int, default=2)
	args = parser.parse_args()
